...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-bookshelf/node_modules/bookshelf/lib/collection.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-bookshelf/node_modules/bookshelf/lib/collection.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-bookshelf/node_modules/bookshelf/lib/</a> &#187; collection.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
  fetch: _promise2.default.method(<span class="fstat-no" title="function not covered" >function (options) {</span>
<span class="cstat-no" title="statement not covered" >    options = options ? (0, _lodash.clone)(options) : {};</span>
<span class="cstat-no" title="statement not covered" >    return this.sync(options).select().bind(this).tap(<span class="fstat-no" title="function not covered" >function (response) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (!response || response.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >        throw new this.constructor.EmptyError('EmptyResponse');</span>
      }
    })
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return this._handleEager(response, (0, _lodash.omit)(options, 'columns'));</span>
      }
    }).tap(<span class="fstat-no" title="function not covered" >function (response) {</span>
&nbsp;
      /**
...
<span class="cstat-no" title="statement not covered" >      return this.triggerThen('fetched', this, response, options);</span>
    }).catch(this.constructor.EmptyError, <span class="fstat-no" title="function not covered" >function (err) {</span>
...
<span class="cstat-no" title="statement not covered" >      this.reset([], { silent: true });</span>
    }).return(this);
  }),
&nbsp;
  /**
   ...
   */
  count: _promise2.default.method(<span class="fstat-no" title="function not covered" >function (column, options) {</span>
<span class="cstat-no" title="statement not covered" >    if (!(0, _lodash.isString)(column)) {</span>
<span class="cstat-no" title="statement not covered" >      options = column;</span>
<span class="cstat-no" title="statement not covered" >      column = undefined;</span>
    }
<span class="cstat-no" title="statement not covered" >    if (options) <span class="cstat-no" title="statement not covered" >options = (0, _lodash.clone)(options);</span></span>
<span class="cstat-no" title="statement not covered" >    return this.sync(options).count(column);</span>
  }),
&nbsp;
  /**
   ...
   */
  fetchOne: _promise2.default.method(<span class="fstat-no" title="function not covered" >function (options) {</span>
<span class="cstat-no" title="statement not covered" >    var model = new this.model();</span>
<span class="cstat-no" title="statement not covered" >    model._knex = this.query().clone();</span>
<span class="cstat-no" title="statement not covered" >    this.resetQuery();</span>
<span class="cstat-no" title="statement not covered" >    if (this.relatedData) <span class="cstat-no" title="statement not covered" >model.relatedData = this.relatedData;</span></span>
<span class="cstat-no" title="statement not covered" >    return model.fetch(options);</span>
  }),
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    if (!(0, _lodash.isArray)(relations)) <span class="cstat-no" title="statement not covered" >relations = [relations];</span></span>
<span class="cstat-no" title="statement not covered" >    options = (0, _lodash.extend)({}, options, { shallow: true, withRelated: relations });</span>
<span class="cstat-no" title="statement not covered" >    return new _eager2.default(this.models, this.toJSON(options), new this.model()).fetch(options).return(this);</span>
  }),
&nbsp;
  /**
   ...
   * model}.
   */
  create: _promise2.default.method(<span class="fstat-no" title="function not covered" >function (model, options) {</span>
<span class="cstat-no" title="statement not covered" >    options = options != null ? (0, _lodash.clone)(options) : {};</span>
<span class="cstat-no" title="statement not covered" >    var relatedData = this.relatedData;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    model = this._prepareModel(model, options);</span>
&nbsp;
    // If we've already added things on the query chain,
    // these are likely intended for the model.
<span class="cstat-no" title="statement not covered" >    if (this._knex) {</span>
<span class="cstat-no" title="statement not covered" >      model._knex = this._knex;</span>
<span class="cstat-no" title="statement not covered" >      this.resetQuery();</span>
    }
<span class="cstat-no" title="statement not covered" >    return _helpers2.default.saveConstraints(model, relatedData).save(null, options).bind(this).then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      if (relatedData &amp;&amp; relatedData.type === 'belongsToMany') {</span>
<span class="cstat-no" title="statement not covered" >        return this.attach(model, (0, _lodash.omit)(options, 'query'));</span>
      }
    }).then(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      this.add(model, options);</span>
    }).return(model);
  }),
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    return _helpers2.default.query(this, (0, _lodash.toArray)(arguments));</span>
  },
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    var cloned = BookshelfCollection.__super__.clone.apply(this, arguments);</span>
...
<span class="cstat-no" title="statement not covered" >    var relatedData = this.relatedData;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.set(response, { silent: true, parse: true }).invokeMap('_reset');</span>
<span class="cstat-no" title="statement not covered" >    if (relatedData &amp;&amp; relatedData.isJoined()) {</span>
<span class="cstat-no" title="statement not covered" >      relatedData.parsePivot(this.models);</span>
    }
  },
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    return new _eager2.default(this.models, response, new this.model()).fetch(options);</span>
  }
&nbsp;
}, {
&nbsp;
  extended: <span class="fstat-no" title="function not covered" >function extended(child) {</span>
     ...
     */
<span class="cstat-no" title="statement not covered" >    child.EmptyError = (0, _createError2.default)(this.EmptyError);</span>
  }
&nbsp;
});
&nbsp;
