...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-bookshelf/node_modules/bookshelf/lib/bookshelf.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-bookshelf/node_modules/bookshelf/lib/bookshelf.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-bookshelf/node_modules/bookshelf/lib/</a> &#187; bookshelf.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function Bookshelf(knex) {</span>
<span class="cstat-no" title="statement not covered" >  var bookshelf = {</span>
    VERSION: require('../package.json').version
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  var Model = bookshelf.Model = _model2.default.extend({</span>
&nbsp;
    _builder: builderFn,
&nbsp;
    ...
    _relation: <span class="fstat-no" title="function not covered" >function _relation(type, Target, options) {</span>
<span class="cstat-no" title="statement not covered" >      if (type !== 'morphTo' &amp;&amp; !(0, _lodash.isFunction)(Target)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('A valid target model must be defined for the ' + (0, _lodash.result)(this, 'tableName') + ' ' + type + ' relation');</span>
      }
<span class="cstat-no" title="statement not covered" >      return new Relation(type, Target, options);</span>
    }
  }, {
&nbsp;
    /**
...
&nbsp;
     ...
     * @returns {Collection}
     */
    collection: <span class="fstat-no" title="function not covered" >function collection(models, options) {</span>
<span class="cstat-no" title="statement not covered" >      return new bookshelf.Collection(models || [], (0, _lodash.extend)({}, options, { model: this }));</span>
    },
&nbsp;
&nbsp;
    /**
...
<span class="cstat-no" title="statement not covered" >      return this.forge().count(column, options);</span>
    },
&nbsp;
&nbsp;
    /**
...
<span class="cstat-no" title="statement not covered" >      return this.forge().fetchAll(options);</span>
    }
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  var Collection = bookshelf.Collection = _collection2.default.extend({</span>
&nbsp;
    _builder: builderFn
&nbsp;
  }, {
...
<span class="cstat-no" title="statement not covered" >  Collection.prototype.model = Model;</span>
<span class="cstat-no" title="statement not covered" >  Model.prototype.Collection = Collection;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var Relation = _relation3.default.extend({</span>
...
&nbsp;
  ...
  // the object.
<span class="cstat-no" title="statement not covered" >  (0, _lodash.extend)(bookshelf, _events2.default, _errors2.default, {</span>
&nbsp;
    /**
...
&nbsp;
    ...
    plugin: <span class="fstat-no" title="function not covered" >function plugin(_plugin, options) {</span>
<span class="cstat-no" title="statement not covered" >      var _this = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if ((0, _lodash.isString)(_plugin)) {</span>
<span class="cstat-no" title="statement not covered" >        try {</span>
<span class="cstat-no" title="statement not covered" >          require('./plugins/' + _plugin)(this, options);</span>
        } catch (e) {
...
<span class="cstat-no" title="statement not covered" >            require(_plugin)(this, options);</span>
          }
        }
      } else <span class="cstat-no" title="statement not covered" >if ((0, _lodash.isArray)(_plugin)) {</span>
<span class="cstat-no" title="statement not covered" >        (0, _lodash.each)(_plugin, <span class="fstat-no" title="function not covered" >function (p) {</span></span>
<span class="cstat-no" title="statement not covered" >          _this.plugin(p, options);</span>
        });
      } else {
<span class="cstat-no" title="statement not covered" >        _plugin(this, options);</span>
      }
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  bookshelf.knex = knex;</span>
&nbsp;
  // The `forge` function properly instantiates a new Model or Collection
  // without needing the `new` operator... to make object creation cleaner
  // and more chainable.
<span class="fstat-no" title="function not covered" >  function forge() {</span>
<span class="cstat-no" title="statement not covered" >    return new (Function.prototype.bind.apply(this, [null].concat(Array.prototype.slice.call(arguments))))();</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function builderFn(tableNameOrBuilder) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if ((0, _lodash.isString)(tableNameOrBuilder)) {</span>
<span class="cstat-no" title="statement not covered" >      builder = bookshelf.knex(tableNameOrBuilder);</span>
    } else <span class="cstat-no" title="statement not covered" >if (tableNameOrBuilder == null) {</span>
<span class="cstat-no" title="statement not covered" >      builder = bookshelf.knex.queryBuilder();</span>
    } else {
...
<span class="cstat-no" title="statement not covered" >      builder = tableNameOrBuilder;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return builder.on('query', <span class="fstat-no" title="function not covered" >function (data) {</span></span>
<span class="cstat-no" title="statement not covered" >      return _this2.trigger('query', data);</span>
    });
  }
&nbsp;
  // Attach `where`, `query`, and `fetchAll` as static methods.
<span class="cstat-no" title="statement not covered" >  ['where', 'query'].forEach(<span class="fstat-no" title="function not covered" >function (method) {</span></span>
<span class="cstat-no" title="statement not covered" >    Model[method] = Collection[method] = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      var model = this.forge();</span>
<span class="cstat-no" title="statement not covered" >      return model[method].apply(model, arguments);</span>
    };
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  return bookshelf;</span>
}
&nbsp;
