...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-bookshelf/node_modules/bookshelf/lib/model.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-bookshelf/node_modules/bookshelf/lib/model.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">18.84% <small>(26 / 138)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-bookshelf/node_modules/bookshelf/lib/</a> &#187; model.js</div>
</div>
<div class="body">
...
1425
1426
1427</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
   ...
   * @returns {Model}
   */
  hasOne: <span class="fstat-no" title="function not covered" >function hasOne(Target, foreignKey, foreignKeyTarget) {</span>
<span class="cstat-no" title="statement not covered" >    return this._relation('hasOne', Target, { foreignKey: foreignKey, foreignKeyTarget: foreignKeyTarget }).init(this);</span>
  },
&nbsp;
&nbsp;
  /**
   ...
   * @returns {Collection}
   */
  hasMany: <span class="fstat-no" title="function not covered" >function hasMany(Target, foreignKey, foreignKeyTarget) {</span>
<span class="cstat-no" title="statement not covered" >    return this._relation('hasMany', Target, { foreignKey: foreignKey, foreignKeyTarget: foreignKeyTarget }).init(this);</span>
  },
&nbsp;
&nbsp;
  /**
   ...
   * @returns {Model}
   */
  belongsTo: <span class="fstat-no" title="function not covered" >function belongsTo(Target, foreignKey, foreignKeyTarget) {</span>
<span class="cstat-no" title="statement not covered" >    return this._relation('belongsTo', Target, { foreignKey: foreignKey, foreignKeyTarget: foreignKeyTarget }).init(this);</span>
  },
&nbsp;
&nbsp;
  /**
   ...
   * @returns {Collection}
   */
  belongsToMany: <span class="fstat-no" title="function not covered" >function belongsToMany(Target, joinTableName, foreignKey, otherKey, foreignKeyTarget, otherKeyTarget) {</span>
<span class="cstat-no" title="statement not covered" >    return this._relation('belongsToMany', Target, {</span>
...
&nbsp;
   ...
   */
  morphOne: <span class="fstat-no" title="function not covered" >function morphOne(Target, name, columnNames, morphValue) {</span>
<span class="cstat-no" title="statement not covered" >    return this._morphOneOrMany(Target, name, columnNames, morphValue, 'morphOne');</span>
  },
&nbsp;
&nbsp;
  /**
   ...
   */
  morphMany: <span class="fstat-no" title="function not covered" >function morphMany(Target, name, columnNames, morphValue) {</span>
<span class="cstat-no" title="statement not covered" >    return this._morphOneOrMany(Target, name, columnNames, morphValue, 'morphMany');</span>
  },
&nbsp;
&nbsp;
  /**
   ...
   * @returns {Model}
   */
  morphTo: <span class="fstat-no" title="function not covered" >function morphTo(morphName) {</span>
<span class="cstat-no" title="statement not covered" >    if (!_lodash2.default.isString(morphName)) <span class="cstat-no" title="statement not covered" >throw new Error('The `morphTo` name must be specified.');</span></span>
<span class="cstat-no" title="statement not covered" >    var columnNames = void 0,</span>
        candidates = void 0;
<span class="cstat-no" title="statement not covered" >    if (_lodash2.default.isArray(arguments[1])) {</span>
<span class="cstat-no" title="statement not covered" >      columnNames = arguments[1];</span>
<span class="cstat-no" title="statement not covered" >      candidates = _lodash2.default.drop(arguments, 2);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      columnNames = null;</span>
<span class="cstat-no" title="statement not covered" >      candidates = _lodash2.default.drop(arguments);</span>
    }
<span class="cstat-no" title="statement not covered" >    return this._relation('morphTo', null, { morphName: morphName, columnNames: columnNames, candidates: candidates }).init(this);</span>
  },
&nbsp;
&nbsp;
  /**
   ...
   * @returns {Collection}
   */
  through: <span class="fstat-no" title="function not covered" >function through(Interim, throughForeignKey, otherKey, throughForeignKeyTarget, otherKeyTarget) {</span>
<span class="cstat-no" title="statement not covered" >    return this.relatedData.through(this, Interim, {</span>
...
&nbsp;
   ...
   */
  refresh: <span class="fstat-no" title="function not covered" >function refresh(options) {</span>
&nbsp;
    // If this is new, we use all its attributes. Otherwise we just grab the
    // primary key.
<span class="cstat-no" title="statement not covered" >    var attributes = this.isNew() ? this.attributes : _lodash2.default.pick(this.attributes, this.idAttribute);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this._doFetch(attributes, options);</span>
  },
&nbsp;
&nbsp;
  /**
   ...
   *
   */
  fetch: <span class="fstat-no" title="function not covered" >function fetch(options) {</span>
&nbsp;
    // Fetch uses all set attributes.
<span class="cstat-no" title="statement not covered" >    return this._doFetch(this.attributes, options);</span>
  },
&nbsp;
&nbsp;
  _doFetch: _promise2.default.method(<span class="fstat-no" title="function not covered" >function (attributes, options) {</span>
<span class="cstat-no" title="statement not covered" >    options = options ? _lodash2.default.clone(options) : {};</span>
&nbsp;
    // Run the `first` call on the `sync` object to fetch a single model.
<span class="cstat-no" title="statement not covered" >    return this.sync(options).first(attributes).bind(this)</span>
&nbsp;
    // Jump the rest of the chain if the response doesn't exist...
    .tap(<span class="fstat-no" title="function not covered" >function (response) {</span>
<span class="cstat-no" title="statement not covered" >      if (!response || response.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >        throw new this.constructor.NotFoundError('EmptyResponse');</span>
      }
    })
&nbsp;
...
&nbsp;
    ...
    .tap(<span class="fstat-no" title="function not covered" >function (response) {</span>
<span class="cstat-no" title="statement not covered" >      if (options.withRelated) {</span>
<span class="cstat-no" title="statement not covered" >        return this._handleEager(response, _lodash2.default.omit(options, 'columns'));</span>
      }
    }).tap(<span class="fstat-no" title="function not covered" >function (response) {</span>
&nbsp;
      /**
       ...
       *   be resolved.
       */
<span class="cstat-no" title="statement not covered" >      return this.triggerThen('fetched', this, response, options);</span>
    }).return(this).catch(this.constructor.NotFoundError, <span class="fstat-no" title="function not covered" >function (err) {</span>
...
&nbsp;
  // Private for now.
  all: <span class="fstat-no" title="function not covered" >function all() {</span>
<span class="cstat-no" title="statement not covered" >    var collection = this.constructor.collection();</span>
<span class="cstat-no" title="statement not covered" >    collection._knex = this.query().clone();</span>
<span class="cstat-no" title="statement not covered" >    this.resetQuery();</span>
<span class="cstat-no" title="statement not covered" >    if (this.relatedData) <span class="cstat-no" title="statement not covered" >collection.relatedData = this.relatedData;</span></span>
...
&nbsp;
   ...
   */
  count: <span class="fstat-no" title="function not covered" >function count(column, options) {</span>
<span class="cstat-no" title="statement not covered" >    return this.all().count(column, options);</span>
  },
&nbsp;
&nbsp;
  /**
   ...
   *
   */
  fetchAll: <span class="fstat-no" title="function not covered" >function fetchAll(options) {</span>
<span class="cstat-no" title="statement not covered" >    var _this = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var collection = this.all();</span>
<span class="cstat-no" title="statement not covered" >    return collection.once('fetching', <span class="fstat-no" title="function not covered" >function (__, columns, opts) {</span></span>
      /**
       ...
       * @returns {Promise}
       */
<span class="cstat-no" title="statement not covered" >      return _this.triggerThen('fetching:collection', collection, columns, opts);</span>
    }).once('fetched', <span class="fstat-no" title="function not covered" >function (__, resp, opts) {</span>
      /**
       ...
       * @returns {Promise}
       */
<span class="cstat-no" title="statement not covered" >      return _this.triggerThen('fetched:collection', collection, resp, opts);</span>
    }).fetch(options);
  },
&nbsp;
&nbsp;
   ...
   */
  load: _promise2.default.method(<span class="fstat-no" title="function not covered" >function (relations, options) {</span>
<span class="cstat-no" title="statement not covered" >    var columns = this.format((0, _extends3.default)({}, this.attributes));</span>
<span class="cstat-no" title="statement not covered" >    var withRelated = _lodash2.default.isArray(relations) ? relations : [relations];</span>
<span class="cstat-no" title="statement not covered" >    return this._handleEager([columns], (0, _extends3.default)({}, options, { shallow: true, withRelated: withRelated })).return(this);</span>
  }),
&nbsp;
  /**
   * @method Model#save
   ...
   */
  save: _promise2.default.method(<span class="fstat-no" title="function not covered" >function (key, val, options) {</span>
<span class="cstat-no" title="statement not covered" >    var attrs = void 0;</span>
&nbsp;
    // Handle both `"key", value` and `{key: value}` -style arguments.
<span class="cstat-no" title="statement not covered" >    if (key == null || (typeof key === 'undefined' ? 'undefined' : (0, _typeof3.default)(key)) === "object") {</span>
<span class="cstat-no" title="statement not covered" >      attrs = key || {};</span>
<span class="cstat-no" title="statement not covered" >      options = _lodash2.default.clone(val) || {};</span>
    } else {
<span class="cstat-no" title="statement not covered" >      (attrs = {})[key] = val;</span>
<span class="cstat-no" title="statement not covered" >      options = options ? _lodash2.default.clone(options) : {};</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _promise2.default.bind(this).then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      return this.saveMethod(options);</span>
    }).then(<span class="fstat-no" title="function not covered" >function (method) {</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      if (method === 'insert' || options.defaults) {</span>
<span class="cstat-no" title="statement not covered" >        var defaults = _lodash2.default.result(this, 'defaults');</span>
<span class="cstat-no" title="statement not covered" >        if (defaults) {</span>
<span class="cstat-no" title="statement not covered" >          attrs = _lodash2.default.defaultsDeep({}, attrs, this.attributes, defaults);</span>
        }
      }
&nbsp;
      // Set the attributes on the model. Note that we do this before adding
      // timestamps, as `timestamp` calls `set` internally.
<span class="cstat-no" title="statement not covered" >      this.set(attrs, { silent: true });</span>
&nbsp;
      // Now set timestamps if appropriate. Extend `attrs` so that the
      // timestamps will be provided for a patch operation.
<span class="cstat-no" title="statement not covered" >      if (this.hasTimestamps) {</span>
<span class="cstat-no" title="statement not covered" >        _lodash2.default.extend(attrs, this.timestamp(_lodash2.default.extend(options, { silent: true })));</span>
      }
&nbsp;
      // If there are any save constraints, set them on the model.
<span class="cstat-no" title="statement not covered" >      if (this.relatedData &amp;&amp; this.relatedData.type !== 'morphTo') {</span>
<span class="cstat-no" title="statement not covered" >        _helpers2.default.saveConstraints(this, this.relatedData);</span>
      }
&nbsp;
      // Gives access to the `query` object in the `options`, in case we need it
      // in any event handlers.
<span class="cstat-no" title="statement not covered" >      var sync = this.sync(options);</span>
<span class="cstat-no" title="statement not covered" >      options.query = sync.query;</span>
&nbsp;
      /**
       * Saving event.
       *
...
&nbsp;
       ...
       * @returns {Promise}
       */
<span class="cstat-no" title="statement not covered" >      return this.triggerThen(method === 'insert' ? 'creating saving' : 'updating saving', this, attrs, options).bind(this).then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        return sync[options.method](method === 'update' &amp;&amp; options.patch ? attrs : this.attributes);</span>
      }).then(<span class="fstat-no" title="function not covered" >function (resp) {</span>
&nbsp;
        // After a successful database save, the id is updated if the model was created
<span class="cstat-no" title="statement not covered" >        if (method === 'insert' &amp;&amp; this.id == null) {</span>
<span class="cstat-no" title="statement not covered" >          var updatedCols = {};</span>
<span class="cstat-no" title="statement not covered" >          updatedCols[this.idAttribute] = this.id = resp[0];</span>
<span class="cstat-no" title="statement not covered" >          var updatedAttrs = this.parse(updatedCols);</span>
<span class="cstat-no" title="statement not covered" >          _lodash2.default.assign(this.attributes, updatedAttrs);</span>
        } else <span class="cstat-no" title="statement not covered" >if (method === 'update' &amp;&amp; resp === 0) {</span>
<span class="cstat-no" title="statement not covered" >          if (options.require !== false) {</span>
<span class="cstat-no" title="statement not covered" >            throw new this.constructor.NoRowsUpdatedError('No Rows Updated');</span>
          }
        }
&nbsp;
        // In case we need to reference the `previousAttributes` for the this
        // in the following event handlers.
<span class="cstat-no" title="statement not covered" >        options.previousAttributes = this._previousAttributes;</span>
&nbsp;
...
&nbsp;
         ...
         * @returns {Promise}
         */
<span class="cstat-no" title="statement not covered" >        return this.triggerThen(method === 'insert' ? 'created saved' : 'updated saved', this, resp, options);</span>
      });
    }).return(this);
  }),
&nbsp;
   ...
   */
  destroy: _promise2.default.method(<span class="fstat-no" title="function not covered" >function (options) {</span>
<span class="cstat-no" title="statement not covered" >    options = options ? _lodash2.default.clone(options) : {};</span>
<span class="cstat-no" title="statement not covered" >    var sync = this.sync(options);</span>
<span class="cstat-no" title="statement not covered" >    options.query = sync.query;</span>
<span class="cstat-no" title="statement not covered" >    return _promise2.default.bind(this).then(<span class="fstat-no" title="function not covered" >function () {</span></span>
&nbsp;
       ...
       * @returns {Promise}
       */
<span class="cstat-no" title="statement not covered" >      return this.triggerThen('destroying', this, options);</span>
    }).then(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      return sync.del();</span>
    }).then(<span class="fstat-no" title="function not covered" >function (resp) {</span>
<span class="cstat-no" title="statement not covered" >      if (options.require &amp;&amp; resp === 0) {</span>
<span class="cstat-no" title="statement not covered" >        throw new this.constructor.NoRowsDeletedError('No Rows Deleted');</span>
      }
...
&nbsp;
       ...
       * @returns {Promise}
       */
<span class="cstat-no" title="statement not covered" >      return this.triggerThen('destroyed', this, resp, options);</span>
    }).then(this._reset);
  }),
&nbsp;
  /**
   ...
   */
  resetQuery: <span class="fstat-no" title="function not covered" >function resetQuery() {</span>
<span class="cstat-no" title="statement not covered" >    this._knex = null;</span>
...
<span class="cstat-no" title="statement not covered" >    return _helpers2.default.query(this, _lodash2.default.toArray(arguments));</span>
  },
&nbsp;
&nbsp;
  /**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.query.apply(this, ['where'].concat(args));</span>
  },
&nbsp;
&nbsp;
  /**
   ...
   */
  orderBy: <span class="fstat-no" title="function not covered" >function orderBy() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _helpers2.default.orderBy.apply(_helpers2.default, [this].concat(args));</span>
  },
&nbsp;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    var cloned = BookshelfModel.__super__.clone.apply(this, arguments);</span>
<span class="cstat-no" title="statement not covered" >    if (this._knex != null) {</span>
<span class="cstat-no" title="statement not covered" >      cloned._knex = cloned._builder(this._knex.clone());</span>
    }
...
&nbsp;
   ...
   * @returns Sync
   */
  sync: <span class="fstat-no" title="function not covered" >function sync(options) {</span>
<span class="cstat-no" title="statement not covered" >    return new _sync2.default(this, options);</span>
  },
&nbsp;
&nbsp;
  /**
   ...
   * @private
   */
  _morphOneOrMany: <span class="fstat-no" title="function not covered" >function _morphOneOrMany(Target, morphName, columnNames, morphValue, type) {</span>
<span class="cstat-no" title="statement not covered" >    if (!_lodash2.default.isArray(columnNames)) {</span>
      // Shift by one place
<span class="cstat-no" title="statement not covered" >      morphValue = columnNames;</span>
<span class="cstat-no" title="statement not covered" >      columnNames = null;</span>
    }
<span class="cstat-no" title="statement not covered" >    if (!morphName || !Target) <span class="cstat-no" title="statement not covered" >throw new Error('The polymorphic `name` and `Target` are required.');</span></span>
<span class="cstat-no" title="statement not covered" >    return this._relation(type, Target, { morphName: morphName, morphValue: morphValue, columnNames: columnNames }).init(this);</span>
  },
&nbsp;
&nbsp;
  /**
   ...
   */
  _handleResponse: <span class="fstat-no" title="function not covered" >function _handleResponse(response) {</span>
<span class="cstat-no" title="statement not covered" >    var relatedData = this.relatedData;</span>
<span class="cstat-no" title="statement not covered" >    this.set(this.parse(response[0]), { silent: true })._reset();</span>
<span class="cstat-no" title="statement not covered" >    if (relatedData &amp;&amp; relatedData.isJoined()) {</span>
<span class="cstat-no" title="statement not covered" >      relatedData.parsePivot([this]);</span>
    }
  },
&nbsp;
&nbsp;
   ...
   * @param {Object} Response from Knex query.
   */
  _handleEager: <span class="fstat-no" title="function not covered" >function _handleEager(response, options) {</span>
<span class="cstat-no" title="statement not covered" >    return new _eager2.default([this], response, this).fetch(options);</span>
  }
}, {
  extended: <span class="fstat-no" title="function not covered" >function extended(child) {</span>
    /**
     ...
     *   `{require: true}` option.
     */
<span class="cstat-no" title="statement not covered" >    child.NotFoundError = (0, _createError2.default)(this.NotFoundError);</span>
&nbsp;
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    child.NoRowsUpdatedError = (0, _createError2.default)(this.NoRowsUpdatedError);</span>
&nbsp;
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    child.NoRowsDeletedError = (0, _createError2.default)(this.NoRowsDeletedError);</span>
  }
});
&nbsp;
